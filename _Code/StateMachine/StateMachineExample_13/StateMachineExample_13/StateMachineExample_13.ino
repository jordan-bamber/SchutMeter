...
//Serial.print("state 1");
          ...
          case 3 :
           ...
           // Serial.print("Volts1 right before evaluation  = ");
            //Serial.println(PD1_volts_sample1);

             //Serial.print("Volts2 right before evaluation  = ");
            //Serial.println(PD1_volts_sample2);

            if((PD1_volts_sample2-PD1_volts_sample1) <= 2){
              //found segment!


               // Serial.print("LED1 seg found");
          ...
          case 7 :
            ...
            if((PD2_volts_sample2-PD2_volts_sample1) <= 2){
              //found segment!

              Serial.print("LED2 seg found");
