   ...
   if ( IFS0bits.T2IF = 1){  //if timer 2 ticked
      ...
      switch(state) {
           case 1 :
            ...
            ADC = analogRead(B0);
            volts_sample1 = ADC_to_Volts_3_3(ADC);

            Serial.print("ADC1  = ");
            Serial.println(ADC);
            
            Serial.print("Volts1 right after acquisition  = ");
            Serial.println(volts_sample1);
          ...
          case 3 :
            ...
            ADC = analogRead(B0);
            volts_sample2 = ADC_to_Volts_3_3(ADC);
            ...
            */
            ...
            Serial.println(volts_sample2-volts_sample1);
  
            if((volts_sample2-volts_sample1) <= 1){
              //found segment!
               //PIN RG6/G_4 (Port G) 
        ...
        /*
          ...
          case 7 :
             Serial.print("State 7\n");
             //PIN PMD0/RE0 (Port E) 
             LATEbits.LATE1=0;     //Set pin 0 in Latch E register to 0, turn LED2 OFF
             break;
          case 8 :
             Serial.print("State 8\n");
             //paste code to sample photo diode 2 here
