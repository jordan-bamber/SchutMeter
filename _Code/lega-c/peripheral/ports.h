 ...
 *****************************************************************************/
  ...
  #if !defined( _NO_LEGACY_PORTS_PLIB )
    #error "Device not supported by legacy Ports Plib!"
    #define _NO_LEGACY_PORTS_PLIB
  #endif
 ...
 *****************************************************************************/
     ...
     defined(__32MX570F512H__) || \
     defined(__32MX570F512L__)
  #error "Device not supported by legacy peripheral library!"
#elif   (((__PIC32_FEATURE_SET__ >= 100) && (__PIC32_FEATURE_SET__ <= 299)) || defined(__32MXGENERIC__))
